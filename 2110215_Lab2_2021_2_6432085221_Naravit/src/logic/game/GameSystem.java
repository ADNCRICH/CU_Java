...
public class GameSystem {
	...
	public void setAllWhitePieces(ArrayList<BaseUnit> allWhitePieces) {
		this.allWhitePieces = allWhitePieces;
	}

	public void setAllRedPieces(ArrayList<BaseUnit> allRedPieces) {
		this.allRedPieces = allRedPieces;
	}
